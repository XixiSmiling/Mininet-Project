...
class Tutorial (object):
  ...
  def __init__ (self, connection):
    ...
    self.arp_cache = {'10.0.1.100': "00:00:00:00:00:01", '10.0.2.100': "00:00:00:00:00:02" , '10.0.3.100': "00:00:00:00:00:03", '10.0.1.1': "12:12:12:12:12:12", '10.0.2.1': "12:12:12:12:12:12" , '10.0.3.1': "12:12:12:12:12:12"}
    self.ip_to_port = {'10.0.1.100':1, '10.0.2.100':2, '10.0.3.100':3}
    self.routing_table = {'10.0.1.100' : ['10.0.1.100/24', 's1-eth1', '10.0.1.1', 1], '10.0.2.100' : ['10.0.2.100/24', 's1-eth2', '10.0.2.1', 2], '10.0.3.100' : ['10.0.3.100/24', 's1-eth3', '10.0.3.1', 3]}
  ...
  def _handle_PacketIn (self, event):
    ...
    if packet.type == myPkt.ethernet.IP_TYPE:
        if packet.payload.protocol != myPkt.ipv4.ICMP_PROTOCOL:
            ...
            if self.ip_to_port.get(dst_ip):
                log.debug("sending parket to " + str(dst_ip))
                log.debug(str(packet.src) + "  " + str(packet.dst))
                packet.src = packet.dst
                packet.dst = myAddr.EthAddr(self.arp_cache[str(dst_ip)])
                log.debug(str(packet.src) + "  " + str(packet.dst))
                msg = of.ofp_packet_out()
                msg.actions.append(of.ofp_action_output(port = self.ip_to_port[str(dst_ip)]))
